...
export default function HutangPage() {
  ...
  // Hander untuk toggle tampilan detail transaksi (mobile)
  ...
  // Hander klik header untuk sorting
  ...
  return (
    <div className="p-4 dark:bg-boxdark dark:text-gray-100">
      ...
      >
          ...
          <Select
            ...
            classNames={{
              control: () =>
                ...
                'px-3 py-0 text-sm',
              valueContainer: () =>
                'h-full px-0',   // full tinggi tanpa padding vertikal
              input: () =>
            ...
            value={
              suppliers
                .filter(s => s._id === selectedSupplierId)
                .map(s => ({ value: s._id, label: s.nama }))[0] || null
            }
            onChange={sel => setSelectedSupplierId(sel?.value ?? "")}
          />

        </div>
        {/* Tanggal Range with labels */}
        ...
        <button
          type="submit"
          className="col-span-full bg-tosca text-white px-4 py-2 rounded"
        >
          Terapkan Filter
        </button>
      </form>
                    ...
                    <div className="hidden space-x-2 md:flex">
                      ...
                      <div className="flex-1">
                        <button
                          ...
                          className="hover:bg-toscadark-600 w-full rounded bg-tosca px-4 py-2 text-sm text-white"
                        >
                          Invoice
                        </button>
                      </div>
                  ...
                  <div className="mt-2 space-y-2">
                    ...
                    <div className="mt-2 flex flex-col space-y-2">
                      ...
                      <button
                        ...
                        className="hover:bg-toscadark-600 rounded bg-tosca px-4 py-2 text-sm text-white"
                      >
                        Lunasi
                      </button>
                      <button
          ...
          <div className="w-full max-w-md rounded-lg bg-white p-6 dark:bg-gray-800">
            ...
            <div className="flex justify-end space-x-2">
              ...
              <button
                ...
                className="rounded bg-tosca px-4 py-2 text-sm text-white"
              >
