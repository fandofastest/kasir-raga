...
import { formatDateWithTimezone, getCurrentDateWithTimezone } from "@/lib/timezone";
        ...
        <div className="mb-4">
          <div className="grid grid-cols-2 gap-4 text-lg font-bold sm:grid-cols-3">
            <div className="rounded bg-gray-100 p-2 dark:bg-gray-800">
              <p className="text-sm font-medium">Total Transaksi Biaya</p>
              <p className="text-lg">{totalTransaksi}</p>
            </div>
            <div className="rounded bg-gray-100 p-2 dark:bg-gray-800">
              <p className="text-sm font-medium">Nominal Transaksi Biaya</p>
              <p className="text-lg">
